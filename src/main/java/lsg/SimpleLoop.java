...
public class SimpleLoop {
  public SimpleLoop() {
    ...
    nestingLevel = 0;
    depthLevel = 0;
    basicBlocks = new ObjectOpenHashSet<BasicBlock>();
    children = new ObjectOpenHashSet<SimpleLoop>();
  }
  ...
  public void dump(int indent) {
    ...
    System.out.format("loop-%d nest: %d depth %d %s", counter, nestingLevel,
        depthLevel, isReducible ? "" : "(Irreducible) ");
  ...
  // Getters/Setters
  public ObjectOpenHashSet<SimpleLoop> getChildren() {
    return children;
  }
  ...
  private ObjectOpenHashSet<BasicBlock> basicBlocks;
  private ObjectOpenHashSet<SimpleLoop> children;
